...
import com.revature.services.ChangeRequestServices;
import com.revature.services.ChangeRequestServicesImpl;
...
public class ChangeRequestController {
	private static ChangeRequestServices infoRequestServ = new ChangeRequestServicesImpl();
	...
	public static void submitChangeRequest(Context ctx) {
		System.out.println("Submitting an info request in the controller");
		ChangeRequest infoRequest = new ChangeRequest();
		...
		infoRequestServ.addChangeRequest(infoRequest);
		ctx.status(200);
		}
	}
